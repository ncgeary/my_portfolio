      ...
      <Aux>
        ...
        <div className="card">
          <div className="card-body">
            ...
            <a href="https://github.com/ncgeary/TaskList" rel="noopener noreferrer" target="_blank" className="card-link">Source Code</a>
            <a href="https://ncgeary.github.io/TaskList/" rel="noopener noreferrer" target="_blank" className="card-link">Live Demo</a>
          </div>
        </div>
